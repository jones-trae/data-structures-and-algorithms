...
const addOne = (arr) => {
  ...
  return increment;// Solution code here...
};
...
const addExclamation = (arr) => {
  ...
  arr.forEach(str => {
    excl.push(str + '!');// Solution code here...
  });
  return excl;
};
...
const allUpperCase = (arr) => {
  ...
  arr.forEach((str) => {
    ...
    newArr.push(upCased);// Solution code here...
  });
  return newArr;
};
...
const addValues = (arr, value) => {
  arr.push(value); // Solution code here...
};
...
const createList = (availableItems) => {
  ...
  return newList;// Solution code here...
};
