...
const sortNames = (arr) => {
  let newArr = arr.sort((fName, lName) => {
    return fName > lName ? 1 : -1;
  });
  return newArr;// Solution code here...
};
...
const sortBackwards = (arr) => {
  let bArr = arr.sort((fNum, sNum) => {
    return sNum - fNum;
  });
  return bArr;// Solution code here...
};
...
const alphabetize = (arr) => {
  let aArr = arr.sort((fStr, sStr) => {
    return fStr > sStr ? 1 : -1;
  });
  return aArr; // Solution code here...
};
...
const sortByPrice = (arr) => {
  let newArr = arr.sort((fProd, sProd) => {
    return fProd.price - sProd.price;
  });
  return newArr;
};
